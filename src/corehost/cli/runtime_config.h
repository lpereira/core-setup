...
public:
    ...
    bool parse_opts(const rapidjson::Value& opts);
...
private:
    ...
    bool parse_framework(const rapidjson::Value& fx_obj, fx_reference_t& fx_out);
    bool read_framework_array(const rapidjson::Value& frameworks);
