...
private:
    bool load_self_contained(const pal::string_t& deps_path, const rapidjson::Value& json, const pal::string_t& target_name);
    bool load_framework_dependent(const pal::string_t& deps_path, const rapidjson::Value& json, const pal::string_t& target_name, const rid_fallback_graph_t& rid_fallback_graph);
    bool load(bool is_framework_dependent, const pal::string_t& deps_path, const rid_fallback_graph_t& rid_fallback_graph);
    bool process_runtime_targets(const rapidjson::Value& json, const pal::string_t& target_name, const rid_fallback_graph_t& rid_fallback_graph, rid_specific_assets_t* p_assets);
    bool process_targets(const rapidjson::Value& json, const pal::string_t& target_name, deps_assets_t* p_assets);
    ...
    pal::string_t get_optional_property(const rapidjson::Value& properties, const pal::string_t& key) const;
    pal::string_t get_optional_path(const rapidjson::Value& properties, const pal::string_t& key) const;
